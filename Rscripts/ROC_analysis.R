#########################
toutput = read.csv("/Volumes/qtran/Semisupervised_Learning/processed_data/family_results/Calibrated_Trans_scores_MCF_wide.csv", header=TRUE)
base_dir = "/Volumes/qtran/Semisupervised_Learning/figures/family_results/"

toutput_all = read.csv("/Volumes/qtran/Semisupervised_Learning/processed_data/family_results/Calibrated_Trans_scores_MCF_long.csv", header=TRUE)
...
######RAW MAX SCORES########
max_tscore = read.csv("/Volumes/qtran/Semisupervised_Learning/processed_data/family_results/All_MCF_Transductive_MaxScores_SETRED_SVM.csv")
...
pdf(paste0(base_dir, "/ROC_YoudenIndex_Family.pdf"), width=7, height = 7)
plot(rocobj_calb, print.thres="best", print.thres.best.method="youden", col="blue", lwd=2, 
     auc.polygon.col="lightblue", alpha = 0.8,
     print.thres.col="blue", print.thres.adj=c(0.25,-2.0), print.thres.best.weights=c(1, 0.5), 
     print.auc=TRUE, print.auc.y = 1.00, print.auc.x = 0.99, 
     cex.lab=1.3, cex.axis=1.3)
plot(rocobj_raw, print.thres="best", print.thres.best.method="youden", col="red", lwd=2, 
     auc.polygon.col="lightpink",
     print.thres.col="red", print.auc=TRUE, add=TRUE, print.auc.y = 0.86, print.auc.x = 0.85)
legend(x=0.25,y= 0.1, legend=c("raw","calibrated"), lty = c(1,1), col=c("red","blue"), lwd=c(2,2))
dev.off()


pdf(paste0(base_dir, "Threshold_Prec_Rec_Spec_Class.pdf"), width=7, height = 7)
...
pdf(paste0(base_dir, "/Threshold_vs_Spec+Sens_Family.pdf"))
...
pdf(paste0(base_dir, "/Threshold_calibrated_vs_Spec_Sens_Family.pdf"))
...
pdf(paste0(base_dir, "/Prec_vs_Recall_Family.pdf"))
plot(precision ~ threshold , thres_calb, type = "l", 
     subset = is.finite(threshold), col = "blue", lwd=2,
...
#lines(x=c(0,1), c(0,1))
pdf(paste0(base_dir, "Raw_vs_Calibrated_Max_Scores_Family.pdf"))
