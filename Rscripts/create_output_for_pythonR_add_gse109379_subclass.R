...
gse_y = read.csv("./processed_data/GSE109379_old_vs_setred_subclass_labels.csv", header=TRUE)
...
for (i in seeds){
  ...
  write.csv(train_data, file = paste0(bdir, "_35perc.csv"))
  write.csv(test_data, file = paste0(bdir, "_holdOutTest.csv"))
  print("Done File1  & File2!")
  
  train_plus_gse = rbind(train_data, gse_xitest)
  write.csv(train_plus_gse, file = paste0(bdir, "_35perc_gse109379.csv"))
  print("Done File3!")
  
  train_plus_HCgse = rbind(train_data, gse_xitest_hc)
  write.csv(train_plus_HCgse, file = paste0(bdir, "_35perc_HCgse109379.csv"))
  print("Done File4!")
  ...
  write.csv(nothres, file = paste0(bdir, "_70perc.csv"))
  print("Done File5!")
  
  nothres_plus_gse = rbind(nothres, gse_xitest)
  write.csv(nothres_plus_gse, file = paste0(bdir, "_70perc_gse109379.csv"))
  print("Done File6!")
  
  nothres_plus_gseHC = rbind(nothres, gse_xitest_hc)
  write.csv(nothres_plus_gseHC, file = paste0(bdir, "_70perc_gse109379HC.csv")) 
  print("Done File9!")
  
  thres_list = get_high_conf_samples(labelseed, xtrain, ytrain, 0.8)
  write.csv(thres_list, file = paste0(bdir, "_70percHC.csv"))
  print("Done File7!")
  
  xHC_gse = rbind(thres_list, gse_xitest)
  write.csv(xHC_gse, file = paste0(bdir, "_70HC_gse109379.csv")) ###35% HC pseudo label + all gse pseudo-label
  print("Done File8!")
 
  xHC_gseHC = rbind(thres_list, gse_xitest_hc)
  write.csv(xHC_gseHC, file = paste0(bdir, "_70HC_gse109379HC.csv"))
  print("Done File10!")
