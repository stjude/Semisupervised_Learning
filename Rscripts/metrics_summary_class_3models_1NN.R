...
base_dir = "/Volumes/qtran/Semisupervised_Learning_big_private_data/processed_data/class_results"
...
transpose_to_long= function(data){
  ...
  ilong = tidyr::gather(data, pred_family, pred_score, 2:92, factor_key=FALSE)
