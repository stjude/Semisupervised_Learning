...
yttest_seed = yttest[yttest$seed == "seed2_all", ]
...
gc()
saveRDS(bacc, file ="./processed_data/class_results/seed2_all/rf2_acc.rds")
saveRDS(rf2, file = "./processed_data/class_results/rf2_seed2_add35Train_class.rds")
