...
yttest_seed = yttest[yttest$seed == "seed20_all", ]
...
gc()
saveRDS(bacc, file ="./processed_data/class_results/seed20_all/rf2_acc.rds")
saveRDS(rf2, file = "./processed_data/class_results/rf2_seed20_add35Train_class.rds")
...
write.table(tClasses2, file = "./processed_data/class_results/rf2_predicted_label_seed20.txt")
save(predict2, file = "./processed_data/class_results/rf2_seed20_ind_CM.RData")
...
save(eval2, file = "./processed_data/class_results/rf2_seed20_itest_eval.RData")

#color_key = read.csv("/Volumes/qtran/Capper_reference_set/color.key.allRef.csv")

plot_cm(eval2, filename = "./figures/class_results/rf2_seed20_ind_testing_CM.pdf", color_key)
