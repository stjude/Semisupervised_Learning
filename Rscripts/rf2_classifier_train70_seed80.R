...
trainIndex = createDataPartition(
  ...
  p = 0.75,
  list = TRUE,
  groups = min(2, length(comb_data$ytrain))
)
...
gc()
saveRDS(bacc, file ="./processed_data/class_results/seed80_all/rf2_acc.rds")
saveRDS(rf2, file = "./processed_data/class_results/rf2_seed80_add35Train_class.rds")
