...
main_dir = "/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning_big_private_data/processed_data/class_results/"
fig_dir = "/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning_big_private_data/figures/class_results/"
base_dir = "/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning_big_private_data/"
#base_dir = "/Volumes/qtran/Semisupervised_Learning_big_private_data/figures/class_results/"
...
for(m in model){
  ...
  write.table(best.lambda, file = paste0(base_dir, "lambda_for_calibration_model_", m, "_class.txt"))
  save(fit, file =paste0(base_dir, "calibration_model_", m, "_class.RData"))
  ...
  write.csv(pfit, file = paste0(main_dir, "Calibrated_", m, "_Trans_scores_MCF_wide.csv"), row.names=TRUE)
  
  calibrated_scores <- gather(pfit, pred_family, pred_score, 1:91, factor_key=FALSE)  
