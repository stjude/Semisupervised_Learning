source("/rgs01/home/clusterHome/qtran/Semisupervised_Learning/Rscripts/Semisupervised.R")
#################
...
triTraining <- function(
  ...
  if(x.inst){
    ...
    gen.pred1 <- function(r, testing.ints){
      print(paste0("Testing instance ", testing.ints, "\n"))
      print(paste0("Training instance ", r$training.ints, "\n"))
