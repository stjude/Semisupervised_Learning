...
def evaluate(seed, probe_data, model, cv, mcf=False):
    ...
    file70LC= '/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/data_class/seed{}_70percLC.csv'.format(seed)
    
    
    file35_GSELC ='/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/data_class/seed{}_35perc_LCgse109379.csv'.format(seed)
    
    file70LC_GSE = '/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/data_class/seed{}_70LC_gse109379.csv'.format(seed)
    file70_GSELC = '/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/data_class/seed{}_70perc_gse109379LC.csv'.format(seed)
    file70LC_GSELC = '/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/data_class/seed{}_70LC_gse109379LC.csv'.format(seed)
...
def run_all_seeds(rand):
    ...
    for seed in [1, 2, 20, 40, 80, 160, 320]:
        ...
        output_file = '/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/output/result_RF_LCsubClass_seed{}_GSE109379_rand{}.csv'.format(seed, rand)
        output_per_class_file = '/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/output_acc_perClass/result_RF_acc_perLCClass_seed{}_GSE109379_rand{}.csv'.format(seed, rand)
