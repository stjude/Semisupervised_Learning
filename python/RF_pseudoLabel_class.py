...
def run_all_seeds(rand):
    ...
    for seed in [1]:
        ...
        output_file = '/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/output/result_RF_subClass_seed{}_GSE109379_rand{}.csv'.format(seed, rand)
        output_per_class_file = '/research/rgs01/home/clusterHome/qtran/Semisupervised_Learning/python/output_acc_perClass/result_RF_acc_perClass_seed{}_GSE109379_rand{}.csv'.format(seed, rand)
